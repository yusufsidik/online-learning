        ...
        <section className="max-w-screen-2xl mx-auto pb-[160px]">
            <div className="flex flex-col lg:flex-row justify-between">
                ...
                <div className="self-center order-1 lg:order-2">
                    ...
                    <p className="text-[18px] lg:text-[24px] text-[#696984] max-w-[596px] mt-[20px] lg:mt-[30px] mx-auto">Easily launch live assignments, quizzes, and tests. Student results are automatically entered in the online gradebook.</p>
                </div>
            </div>
        </section>
    )
